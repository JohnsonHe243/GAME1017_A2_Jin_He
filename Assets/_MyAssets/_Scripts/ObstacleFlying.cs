...
public class ObstacleFlying : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        for (int i = 0; i < 3; i++)
        {
            GameObject obsInst = GameObject.Instantiate(obstaclePrefab, new Vector3(i * 4f, -14f, 0f), Quaternion.identity);
    ...
    private void MoveObstacles()
    {
        ...
        if (obstacles[0].transform.position.x <= -4f)
        {
            ...
            GameObject obsInst = GameObject.Instantiate(obstaclePrefab, new Vector3(36f, -14f, 0f), Quaternion.identity);
            if (obsCtr++ % 3 == 0)
            {
